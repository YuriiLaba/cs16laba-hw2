...
public class Main {
    public static void main(String[] args) {
        ...
        //test_array.clear();
        //test_array = test_array.add(100);
        //test_array = test_array.add(200);
        //test_array = test_array.add(300);
        //test_array = test_array.remove(2));
        //test_array = test_array.add(1,2000);
        //System.out.println(test_array.toString());
        ...
        //new_stack.enqueue(100);
        //new_stack.enqueue(200);
        //new_stack.dequeue();
        //System.out.println(new_stack.peek());
        //System.out.println(new_stack.toString());
